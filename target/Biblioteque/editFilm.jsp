...
<body>
    <div align="center">
    	<form action="update?id=${film.id}" method="post">
			<table border="1">
				<tr>
					<th>Titre :</th>
					<td><input type="text" name="titre" size="45" value="${film.titre}"/></td>
				</tr>
				<tr>
					<th>Réalisateur :</th>
					<td><input type="text" name="realisateur" size="45" value="<c:out value="${film.realisateur}"/>"/></td>
				</tr>
				<tr>
