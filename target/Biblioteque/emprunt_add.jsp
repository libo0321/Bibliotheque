  ...
  <main>
    <section class="content">
      ...
      <div class="container">
        ...
        <div class="row">
	      <form action="/Biblioteque_war_exploded/emprunt_add" method="post" class="col s12">
	        <div class="row">
	            ...
	            <select id="idLivre" name="idLivre" class="browser-default">
	              ...
	              <option value="" disabled selected>-- Livres --</option>
                    ...
                    <% List<Livre> livres = (List) request.getAttribute("livres");
                        ...
                        {%>
                        <option value=<%=livres.get(i).getId() %>><%='"'+livres.get(i).getTitre()+'"'+" de "+livres.get(i).getAuteur() %></option>
                    <%}
                    %>
