        ...
        <div class="row">
	      ...
	      <form action="/Biblioteque_war_exploded/livre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/Biblioteque_war_exploded/livre_details?id=idDuLivre">Annuler</a> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        </div>
	      </form>
	    </div>	    
      </div>
